    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    List<OrderDetail> orderedItems = new List<OrderDetail>(); // Danh sách các sản phẩm đã được đặt hàng
                    ...
                    cart.Items.ForEach(x => {
                        var product = db.Products.Find(x.ProductId);
                        if (product != null)
                        {
        ...
        public ActionResult AddToCart(int id, int quantity)
        {
            ...
            int soluong = checkProduct.Quantity;
            if (checkProduct != null && quantity <= soluong)
            {
                ShoppingCart cart = (ShoppingCart)Session["Cart"];
                if (cart == null)
                {
